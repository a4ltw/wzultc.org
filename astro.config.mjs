...
export default defineConfig({
  ...
  redirects: {
    ...
    '/files/mid-zh-doc': 'https://docs.google.com/document/d/1AKz97AlUuEnVFlCtSkV5z5ECQpn244X5/edit?usp=drive_link&ouid=113390623339640898195&rtpof=true&sd=true',
    '/files/mid-zh-pdf': 'https://drive.google.com/file/d/1MReE9EYd2ove05M6yGWvkCNAE4Pp_TRX/view?usp=drive_link'
  },

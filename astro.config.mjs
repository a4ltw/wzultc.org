...
export default defineConfig({
  ...
  redirects: {
    ...
    '/files/vis-mdexam': 'https://drive.google.com/open?id=1Y9Skdh70gbD50ZnNfKMkN6Tmfk19NzJU&usp=drive_copy',
    '/files/vis-course': 'https://drive.google.com/open?id=1A6v9nRL0DxUpItEI6nmuo3mDQIDxBdBn&usp=drive_copy',
    '/files/vis-mat': 'https://drive.google.com/open?id=1tvXHGVdhWwk3L4ZoGcMMbSoufKaLs82J&usp=drive_copy',
    '/files/vis-ai': 'https://drive.google.com/open?id=1Hxqa9ZH2qcvGxLERb8GE20Xg7GKw0gAb&usp=drive_copy',
    '/files/vis-vid': 'https://drive.google.com/open?id=1qVbXGtfGL3kx6kqyFPS75nOqRYar6hvt&usp=drive_copy',
